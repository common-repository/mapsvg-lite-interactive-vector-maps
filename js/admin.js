...
(function( $ ) {
    ...
    methods = {
        ...
        save : function (skipMessage){
            ...
            return $.post(ajaxurl, {action: 'mapsvg_save',_wpnonce: mapsvg_nonce.nonce, data: data}, function(id){
                if($.isNumeric(id)){
            ...
            $(document).ready(function(){
                ...
                if(onEditMapScreen){
                    ...
                    $("#save-api-key").on('click', function() {
                        ...
                        if(key && key.length){
                            $.post(ajaxurl, {action: 'mapsvg_save_google_api_key',key: key, _wpnonce: mapsvg_nonce.nonce,}).done(function(data){
