(function($, window, MapSVG){
    ...
    MapSVG.DatabaseSchema.prototype.save = function(fields){
        ...
        return $.post(ajaxurl, {action: 'mapsvg_save_schema', schema: fields, map_id: this.map_id, table: this.table, _wpnonce: mapsvg_nonce.nonce}).done(function(){
            _this.trigger('change');
        });
    };
    ...
    MapSVG.ServerMySQL.prototype.create = function(data){
        ...
        return $.post(ajaxurl, this.actionData('mapsvg_data_create', {data: _data, _wpnonce: mapsvg_nonce.nonce}), null, 'json').done(function(_data){
            data.id = _data.id;
            _this.reindex();
        });
    };
    MapSVG.ServerMySQL.prototype.update = function(data){
        ...
        if(index!==undefined){
            ...
            var _data = this.formatData(data);
            return $.post(ajaxurl, this.actionData('mapsvg_data_update', {data: _data, _wpnonce: mapsvg_nonce.nonce}), null, 'json');
        }
    };
    MapSVG.ServerMySQL.prototype.delete = function(id){
        ...
        return $.post(ajaxurl, this.actionData('mapsvg_data_delete', {data: {id: id}, _wpnonce: mapsvg_nonce.nonce}), null, 'json').done(function(){
            _this.reindex();
        });
    };
